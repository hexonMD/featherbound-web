  ...
  return (
    <main className="prose">
      ...
      <ul>
        ...
        <li><strong>Approximate location</strong> — used to show birds reported near you and to judge rarity. Coordinates saved on a card are rounded to roughly a kilometre before storage.</li>
      ...
      <p>
        ...
        accounts), Cloudflare (media storage and delivery), and Apple (push notifications).
        Reference bird data and range maps come from eBird, iNaturalist, and Wikimedia. We do
